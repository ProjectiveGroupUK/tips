...
# PYPI_VERSION_URL = "https://pypi.org/pypi/tips/json"


def get_version_information() -> str:

    return f'Tips {__version__}'
...
# def get_latest_version() -> dbt.semver.VersionSpecifier:
#     return dbt.semver.VersionSpecifier.from_version_string(__version__)
...
#     latest_plugin = get_latest_version()
